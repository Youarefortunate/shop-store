      ...
      >
        ...
        >
          <el-input-number
            ...
            v-model="editGradeForm.upgrade.expend_money"
          />
          <span style="margin-left: 10px; color: rgba(0, 0, 0, 0.45)"
            >(实际消费金额满{{ editGradeForm.upgrade.expend_money }}元)</span
          >
          <div class="form-item-help">
        ...
        >
          <el-input-number
            ...
            :precision="1"
            controls-position="right"
            v-model="editGradeForm.equity.discount"
          />
          <span style="margin-left: 10px; color: rgba(0, 0, 0, 0.45)"
            >(折扣率{{ editGradeForm.equity.discount }}折)</span
          >
          <div class="form-item-help">
            <p class="extra">
        ...
        >
          <el-radio-group v-model="editGradeForm.status">
  ...
  methods: {
    ...
    setFieldsValue() {
      ...
      this.$nextTick(() => {
        ...
        this.editGradeForm = newData;
        this.editGradeForm.sort = 100;
      });
    },
    // 提交表单
    handleSubmit() {
    ...
    // 重置表单项
    resetForm() {
      this.$refs.EditGradeForm.resetFields();
    },
    // 点击右上角叉号关闭对话框
    handleClose(done) {
      this.handleCancel();
