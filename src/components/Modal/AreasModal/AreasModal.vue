      ...
      <div class="areas-content clearfix">
        <div class="areas-left fl-l">
          <h2 class="areas-title clearfix">
            <span class="fl-l" style="font-weight: 500;">地区选择：</span>
            <a
              ...
              >
                <div class="text clearfix" @click="handleActive(province)">
                  ...
                  <a
                    ...
                    @click="handleSelected($event, 'province', province)"
                    >选择</a
                  >
                </div>
                <ul v-show="!province.isHideChildren" class="areas-sublist">
                  <li
                    class="areas-item"
                    v-for="(city, cidx) in province.city"
                    :key="cidx"
                  >
                    <div class="text clearfix">
                      ...
                      <a
                        class="item-flip fl-r"
                        @click="handleSelected($event, 'city', city)"
                        >选择</a
                      >
                    </div>
                  </li>
        ...
        <div class="areas-right fl-r">
          <h2 class="areas-title" style="font-weight: 500;">已选择：</h2>
          <div class="areas-list">
            <ul class="areas-list-body">
              <li
                class="areas-item"
                ...
                <ul v-show="!province.isHideChildren" class="areas-sublist">
                  ...
                  >
                    <div class="text clearfix">
                      ...
                      <a
                        class="item-flip fl-r"
                        @click="handleUnSelected($event, 'city', city)"
                        >删除</a
                      >
                    </div>
                  </li>
    ...
    initUnSelectedData() {
      ...
      for (const pidx in data) {
        ...
        for (const cidx in province.city) {
          ...
          if (
            !inArray(cityItem.id, selectedCityIds) &&
            !inArray(cityItem.id, excludedCityIds)
          ) {
